// ======================================================================
// DPI_Desktop_Tester.v generated from TopDesign.cysch
// 07/17/2014 at 14:36
...
// UART_v2_30(Address1=0, Address2=0, BaudRate=57600, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, CtrlModeReplacementString=SyncCtl, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=1, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=0, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=0, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=true, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=false, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=false, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=460800, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=true, Use23Polling=true, CY_COMPONENT_NAME=UART_v2_30, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=DATA_COM, CY_INSTANCE_SHORT_NAME=DATA_COM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=30, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=DATA_COM, )
module UART_v2_30_3 (
    rx_clk,
    rx_data,
    tx_clk,
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d3979f9-ac78-4f13-87f0-348173f5f9bd"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_40_1 LIS331HH_SPI (
        .mosi(Net_23),
        .sclk(Net_25),
        .ss(Net_154),
        .miso(Net_19),
    ...
    defparam LIS331HH_SPI.BidirectMode = 0;
    defparam LIS331HH_SPI.HighSpeedMode = 0;
    defparam LIS331HH_SPI.NumberOfDataBits = 8;
    defparam LIS331HH_SPI.ShiftDir = 0;
    ...
    UART_v2_30_2 CONFIG_COM (
        ...
        .rx_data(Net_80),
        .rx_clk(Net_81));
    defparam CONFIG_COM.Address1 = 0;
    defparam CONFIG_COM.Address2 = 0;
    defparam CONFIG_COM.EnIntRXInterrupt = 0;
    defparam CONFIG_COM.EnIntTXInterrupt = 0;
    defparam CONFIG_COM.FlowControl = 0;
    defparam CONFIG_COM.HalfDuplexEn = 0;
    defparam CONFIG_COM.HwTXEnSignal = 1;
    defparam CONFIG_COM.NumDataBits = 8;
    defparam CONFIG_COM.NumStopBits = 1;
    defparam CONFIG_COM.ParityType = 0;
    defparam CONFIG_COM.RXEnable = 1;
    defparam CONFIG_COM.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("817d5bb8-efcc-4b56-a0b3-017311da2078"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b80018d2-549f-48cb-b3b3-1a6a32a48849"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    UART_v2_30_3 DATA_COM (
        ...
        .reset(1'b0),
        .rx(Net_88),
        .tx_interrupt(Net_119),
        .rx_interrupt(Net_120),
        .tx_data(Net_121),
        .tx_clk(Net_122),
        .rx_data(Net_123),
        .rx_clk(Net_124));
    defparam DATA_COM.Address1 = 0;
    defparam DATA_COM.Address2 = 0;
    defparam DATA_COM.EnIntRXInterrupt = 0;
    defparam DATA_COM.EnIntTXInterrupt = 0;
    defparam DATA_COM.FlowControl = 0;
    defparam DATA_COM.HalfDuplexEn = 0;
    defparam DATA_COM.HwTXEnSignal = 1;
    defparam DATA_COM.NumDataBits = 8;
    defparam DATA_COM.NumStopBits = 1;
    defparam DATA_COM.ParityType = 0;
    defparam DATA_COM.RXEnable = 1;
    defparam DATA_COM.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("b36cae9b-9398-4c18-b44e-44c98f4435fa"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4d0b6490-4889-4179-b6ee-6c639fac328c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
